(custom-set-variables
 ...
 '(cabbage-plone-known-buildout-instances (quote (("bin/instance" "fg") ("bin/instance0" "fg") ("bin/instance1" "fg") ("bin/instanceadm" "fg") ("bin/serve" "") ("bin/feedcenter" "fg"))))
 '(cabbage-project-location "/Users/jone/projects/")
 '(css-indent-offset 2)
 '(dabbrev-case-distinction nil)
 '(dabbrev-case-fold-search nil)
 '(erc-autojoin-channels-alist (quote (("freenode.net" "#4tw" "#plone"))))
 ...
 '(erc-modules (quote (autojoin button completion fill irccontrols keep-place list log match menu move-to-prompt netsplit networks noncommands readonly ring services smiley stamp track xdcc)))
 '(erc-nick nil)
 '(erc-prompt ">")
 '(erc-system-name nil)
 '(erc-timestamp-right-column 65)
